...
class Product::BrandsControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create product_brand" do
    assert_difference('Product::Brand.count') do
      post :create, product_brand: {  }
    end
  ...
  test "should update product_brand" do
    patch :update, id: @product_brand, product_brand: {  }
    assert_redirected_to product_brand_path(assigns(:product_brand))
  end

  test "should destroy product_brand" do
    assert_difference('Product::Brand.count', -1) do
